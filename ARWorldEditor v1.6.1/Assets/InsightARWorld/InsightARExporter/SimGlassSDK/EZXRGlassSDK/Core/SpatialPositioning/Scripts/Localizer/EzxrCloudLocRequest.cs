...
{
    public struct EzxrCloudLocRequestMeta
    {
        public double timestamp;           // the query jpg's timestamp

        public EzxrCloudLocRequestMeta(double time)
        {
            this.timestamp = time;
        }
    }

    public struct EzxrCloudLocRequest
    {
        public EzxrCloudLocRequestMeta meta;  // query struct
    ...
    public struct EzxrCloudLocRequestImpl
    {
        ...
        public EzxrCloudLocRequestImpl(EzxrCloudLocRequest requestData)
        {
    ...
    public struct EzxrCloudLocResultMeta
    {
        public int status;
        public double timestamp;           // the query jpg's timestamp
    }

    public struct EzxrCloudLocResult
    {
        public EzxrCloudLocResultMeta meta; //result stuct
    ...
    public struct EzxrCloudLocResultStatus
    {
        public int algCode;
